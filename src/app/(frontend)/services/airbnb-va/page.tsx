...
export async function generateMetadata(): Promise<Metadata> {
  const seoDoc = await getPageSEO('services/airbnb-va').catch(() => null)
  return generatePageMeta({
    slug: 'services/airbnb-va',
    seoDoc,
...
const subServices = [
  { title: 'Multi-Platform Listing', href: '/services/airbnb-va/multi-platform-listing' },
  { title: 'Listing Creation & Optimisation', href: '/services/airbnb-va/listing-creation-optimisation' },
  { title: 'Pricing Optimisation', href: '/services/airbnb-va/pricing-optimisation' },
  { title: 'Professional Photography', href: '/services/airbnb-va/professional-photography' },
  { title: 'Guest Communication', href: '/services/airbnb-va/guest-communication' },
  { title: 'Guest Vetting', href: '/services/airbnb-va/guest-vetting' },
  { title: 'Guest Check-In & Check-Out', href: '/services/airbnb-va/guest-check-in-check-out' },
  { title: 'Calendar Management', href: '/services/airbnb-va/calendar-management' },
  { title: 'Cleaning Coordination', href: '/services/airbnb-va/cleaning-coordination' },
  { title: 'Linen & Toiletries Management', href: '/services/airbnb-va/linen-toiletries' },
  { title: 'Property Maintenance', href: '/services/airbnb-va/property-maintenance' },
  { title: 'Monthly Finance Reporting', href: '/services/airbnb-va/monthly-finance-reporting' },
  { title: 'Graphical Content Creation', href: '/services/airbnb-va/graphical-content-creation' },
]
  ...
  return (
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLdScript([
            webPageSchema({
              ...
              url: `${siteConfig.url}/services/airbnb-va`,
              type: 'Service',
            }),
            breadcrumbSchema([
              { name: 'Home', href: '/' },
      ...
      <ServiceTemplate
        ...
        eyebrow="Services · Airbnb Virtual Assistant"
        title="Airbnb Virtual Assistant Services That Actually Run Your Operations"
