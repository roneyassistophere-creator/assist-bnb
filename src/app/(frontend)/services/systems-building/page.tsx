...
const slug = 'services/systems-building'
...
const subServices = [
  { title: 'STR Business Setup', href: '/services/systems-building/str-business-setup' },
  { title: 'STR Automation', href: '/services/systems-building/str-automation' },
  { title: 'SOP Creation', href: '/services/systems-building/sop-creation' },
  { title: 'Team Structuring', href: '/services/systems-building/team-structuring' },
]
  ...
  return (
    <>
      ...
      <ServiceTemplate
        ...
        eyebrow="Services · Systems Building"
          ...
          <section className="py-20 bg-muted">
            <div className="container max-w-5xl">
              <h2 className="text-2xl md:text-3xl font-bold mb-12 text-center">
                Explore Systems Building Services
              </h2>
