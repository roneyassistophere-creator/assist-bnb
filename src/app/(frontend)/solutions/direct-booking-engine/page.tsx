...
export async function generateMetadata(): Promise<Metadata> {
  const seoDoc = await getPageSEO('solutions/direct-booking-engine').catch(() => null)
  return generatePageMeta({
    slug: 'solutions/direct-booking-engine',
    seoDoc,
...
const subServices = [
  { title: 'Direct Booking Website', href: '/solutions/direct-booking-engine/direct-booking-website' },
  { title: 'Direct Booking Conversions', href: '/solutions/direct-booking-engine/direct-booking-conversions' },
  { title: 'Booking Engine Integration', href: '/solutions/direct-booking-engine/booking-engine-integration' },
  { title: 'Payment Setup', href: '/solutions/direct-booking-engine/payment-setup' },
  { title: 'SEO & Organic Growth', href: '/solutions/direct-booking-engine/seo-organic-growth' },
  { title: 'Google Ads', href: '/solutions/direct-booking-engine/google-ads' },
]
  ...
  return (
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLdScript([
            webPageSchema({
              ...
              url: `${siteConfig.url}/solutions/direct-booking-engine`,
              type: 'Service',
            }),
            breadcrumbSchema([
              { name: 'Home', href: '/' },
              { name: 'Solutions', href: '/solutions' },
              { name: 'Direct Booking Engine', href: '/solutions/direct-booking-engine' },
            ]),
          ]),
        }}
      />
      ...
      <ServiceTemplate
        ...
        eyebrow="Solutions · Direct Booking Engine"
          ...
          <section className="py-20 bg-muted">
            <div className="container max-w-5xl">
              <h2 className="text-2xl md:text-3xl font-bold mb-12 text-center">
                Explore Direct Booking Engine Solutions
              </h2>
